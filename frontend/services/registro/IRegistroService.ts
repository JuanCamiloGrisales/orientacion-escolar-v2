...
export interface IRegistroService {
  ...
  createRegistro(data: RegistroFormData, files: { [key: string]: File[] }): Promise<void>;
  updateRegistro(id: string, formData: RegistroFormData, summary: string): Promise<RegistroDetalle>;
  patchRegistro(id: string, formData: RegistroFormData, summary: string): Promise<RegistroDetalle>;
}
