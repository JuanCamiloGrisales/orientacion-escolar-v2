...
const FormField: React.FC<FormFieldProps> = ({
  ...
  const handleInputChange = (
    ...
    if (type === "file") {
      newValue = Array.from((e.target as HTMLInputElement).files || [])
        .map((file) => file.name)
        .join(", ");
    }
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            {options.length > 0 && showOptions && (
              <div
                className="absolute z-10 w-full mt-1 bg-white rounded-2xl border-2 border-indigo-100 
                                          shadow-lg max-h-[280px] overflow-hidden"
              >
                <div className="p-2">
                  <div
                    className="overflow-y-auto max-h-[260px] scrollbar-thin scrollbar-thumb-indigo-200 
                      ...
                      <div className="space-y-1">
                        {filteredOptions.map((option, index) => (
                          <div
                            ...
                            onMouseDown={(e) =>
                              handleOptionMouseDown(e, option)
                            }
                          >
                            {option}
                          </div>
